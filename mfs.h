...
typedef struct
	...
	int maxEntries; /* Max num of entries in directory */
...
int fs_setcwd(char *pathname);   //linux chdir cd
...
// called by displayFiles() (which is called by cmd_ls) in fsshell.c
int fs_stat(const char *path, struct fs_stat *buf); //used for ls -l 

//------------Our group's function prototypes----------------
